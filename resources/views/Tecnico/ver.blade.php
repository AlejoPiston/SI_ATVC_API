...
<div class="card">
    <div class="card-header border-0">
      <div class="row align-items-center">
        <div class="col">
          <h3 class="mb-0">Técnico # {{ $tecnico->id }}</h3>
        </div>
      </div>
    </div>
    <div class="card-body">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h3 font-weight-bold mb-0">{{ $tecnico->name }} {{ $tecnico->Apellidos }}</span>
                    </div>
                    <div class="col-auto">
                  ...
                  <p class="mt-3 mb-0 text-sm">
                    ...
                    <span class="text-nowrap">{{ $tecnico->Cedula }}</span>
                  </p>
                </div>
              </div>
            </div>
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col">
                        ...
                        <span class="h3 font-weight-bold mb-0">{{ $tecnico->email }}</span>
                      </div>
                      <div class="col-auto">
                    ...
                    <p class="mt-3 mb-0 text-sm">
                      ...
                      <span class="text-nowrap">{{ $tecnico->created_at }}</span>
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col">
                        ...
                        <span class="h3 font-weight-bold mb-0">{{ $tecnico->Tipo }}</span>
                      </div>
                      <div class="col-auto">
                    ...
                    <p class="mt-3 mb-0 text-sm">
                      ...
                      <span class="text-nowrap">{{ $tecnico->Estado }}</span>
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h3 font-weight-bold mb-0">{{ $tecnico->Direccion }}</span>
                    </div>
                    <div class="col-auto">
                  ...
                  <p class="mt-3 mb-0 text-sm">
                    ...
                    <span class="text-nowrap">{{ $tecnico->Telefono }}</span>
                  </p>
                </div>
              </div>
            </div>
