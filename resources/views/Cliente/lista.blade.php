    ...
    <div class="card-header border-0">
      <div class="row align-items-center">
        ...
        <div class="col text-right">
          <a href="{{ url('/clientes/create') }}" class="btn btn-success" data-toggle="tooltip" 
            data-placement="top" 
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <button type="button" data-whatever="{{ $cliente->id }}" data-user="{{ $cliente->name }} {{ $cliente->Apellidos }} | {{ $cliente->Cedula }}" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#modal-notification">
                <span data-toggle="tooltip" data-placement="top" title="Eliminar cliente">
                        ...
                        <div class="modal-content bg-gradient-danger">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="py-3 text-center">
                                    ...
                                    <h4 class="heading mt-4">¿Está seguro que desea eliminar este cliente?</h4>
                                    <p>Nombre | Cédula</p> 
                ...
                <script type="text/javascript">
                  $('#modal-notification').on('show.bs.modal', function (event) {
                        ...
                        $('form').attr('action', '{{ url('/clientes/') }}/' + recipient)
                  })
